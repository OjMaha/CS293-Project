...
bool check_cancellations(vector <Order> &orderlist, Order &o, CustomMap2<std::string, Cancellations> &buyMap, CustomMap2<std::string, Cancellations> &sellMap, int n){
    if(o.bs == 'b'){ // buy order
...
void part2(){
    ...
    CustomMap2<std::string, Cancellations> buyMap;    //gonna store stock name and best (highest) rejected buy price 
    CustomMap2<std::string, Cancellations> sellMap;   //gonna store stock name and best (lowest) rejected sell price 
